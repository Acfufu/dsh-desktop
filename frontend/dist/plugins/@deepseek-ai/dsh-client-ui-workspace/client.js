window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-workspace/src/client/rows/Rows.module.css.mjs
		const css$2 = ".LMUtPG_projectRow,.LMUtPG_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.LMUtPG_projectRow:hover,.LMUtPG_sessionRow:hover,.LMUtPG_sessionRow.LMUtPG_selected{background:var(--dsw-alias-interactive-bg-hover)}.LMUtPG_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.LMUtPG_searchResultRow:hover,.LMUtPG_searchResultRow.LMUtPG_selected{background:var(--dsw-alias-interactive-bg-hover)}.LMUtPG_searchResultHeading{align-items:center;min-width:0;display:flex}.LMUtPG_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.LMUtPG_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.LMUtPG_searchResultWorkspace,.LMUtPG_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.LMUtPG_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.LMUtPG_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.LMUtPG_projectRow{box-sizing:border-box;align-items:center;height:34px}.LMUtPG_projectRow .LMUtPG_rowActions{height:20px}.LMUtPG_sessionRow{height:32px;animation:LMUtPG_row-in .15s var(--ds-ease-in-out);gap:0}.LMUtPG_sessionRow .LMUtPG_title{margin:0 6px 0 4px}.LMUtPG_flatSessionRowWithoutStatus .LMUtPG_title{margin-left:0}@keyframes LMUtPG_row-in{0%{opacity:0}}.LMUtPG_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.LMUtPG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.LMUtPG_folderActive{color:var(--dsw-alias-state-business-primary)}.LMUtPG_projectRow .LMUtPG_chevron{display:none}.LMUtPG_projectRow:hover .LMUtPG_chevron{display:inline-flex}.LMUtPG_projectRow:hover .LMUtPG_folder{display:none}.LMUtPG_arrow{transition:transform .15s var(--ds-ease-in-out)}.LMUtPG_arrowOpen{transform:rotate(90deg)}.LMUtPG_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.LMUtPG_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.LMUtPG_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.LMUtPG_sessionRow .LMUtPG_title{flex:1}.LMUtPG_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.LMUtPG_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.LMUtPG_dot{flex:none}.LMUtPG_rowActions{flex:none;align-items:center;gap:12px;display:none}.LMUtPG_projectRow:hover .LMUtPG_rowActions,.LMUtPG_sessionRow:hover .LMUtPG_rowActions,.LMUtPG_projectRow.LMUtPG_menuOpen .LMUtPG_rowActions,.LMUtPG_sessionRow.LMUtPG_menuOpen .LMUtPG_rowActions{display:inline-flex}.LMUtPG_sessionRow:hover .LMUtPG_time,.LMUtPG_sessionRow.LMUtPG_menuOpen .LMUtPG_time{display:none}.LMUtPG_projectRow.LMUtPG_menuOpen,.LMUtPG_sessionRow.LMUtPG_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.LMUtPG_sessionRow.LMUtPG_dropBefore,.LMUtPG_sessionRow.LMUtPG_dropAfter{position:relative}.LMUtPG_sessionRow.LMUtPG_dropBefore:before,.LMUtPG_sessionRow.LMUtPG_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.LMUtPG_sessionRow.LMUtPG_dropBefore:before{top:-7px}.LMUtPG_sessionRow.LMUtPG_dropAfter:after{bottom:-7px}.LMUtPG_hoverContent{flex-direction:column;gap:8px;display:flex}.LMUtPG_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.LMUtPG_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.LMUtPG_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.LMUtPG_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.LMUtPG_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.LMUtPG_iconButton:hover{color:var(--dsw-alias-label-primary)}.LMUtPG_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.LMUtPG_sessionRow,.LMUtPG_arrow{transition:none;animation:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-workspace/src/client/WorkspacePicker.module.css.mjs
		const css$1 = "._7yOqkG_modalAction{min-width:72px}._7yOqkG_modalError,._7yOqkG_menuStatus{margin-top:8px;font-size:12px;line-height:18px}._7yOqkG_modalError{color:var(--dsw-alias-state-error-primary)}._7yOqkG_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-workspace/src/client/WorkspaceBrowser.module.css.mjs
		const css = ".ShtJjG_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.ShtJjG_root.ShtJjG_rail{padding-right:0}.ShtJjG_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ShtJjG_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ShtJjG_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.ShtJjG_root:not(.ShtJjG_rail) .ShtJjG_sectionHeader{margin-top:2px;margin-right:-4px}.ShtJjG_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.ShtJjG_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.ShtJjG_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.ShtJjG_searchSlotExpanded{max-width:100%;padding-left:0}.ShtJjG_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.ShtJjG_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.ShtJjG_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.ShtJjG_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.ShtJjG_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ShtJjG_searchExpanded .ShtJjG_searchButton{width:28px;height:30px}.ShtJjG_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ShtJjG_searchExpanded .ShtJjG_searchButton:hover{background:0 0}.ShtJjG_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.ShtJjG_searchExpanded .ShtJjG_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.ShtJjG_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.ShtJjG_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ShtJjG_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ShtJjG_rail .ShtJjG_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.ShtJjG_rail .ShtJjG_headerActions{max-width:none}.ShtJjG_rail .ShtJjG_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.ShtJjG_rail .ShtJjG_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.ShtJjG_rail .ShtJjG_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.ShtJjG_rail .ShtJjG_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.ShtJjG_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.ShtJjG_rail .ShtJjG_listArea{margin-left:0;margin-right:0;padding-left:0}.ShtJjG_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.ShtJjG_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.ShtJjG_wide{animation:ShtJjG_wide-in .2s var(--ds-ease-in-out)}@keyframes ShtJjG_wide-in{0%{opacity:0}}.ShtJjG_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.ShtJjG_flatList>*+*,.ShtJjG_searchTree>[role=treeitem]+[role=treeitem],.ShtJjG_groupSection>*+*{margin-top:2px}.ShtJjG_searchStatus,.ShtJjG_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.ShtJjG_searchWarning{color:var(--dsw-alias-label-secondary)}.ShtJjG_groupSection{position:relative}.ShtJjG_groupSection+.ShtJjG_groupSection{margin-top:4px}.ShtJjG_listTopDropIndicator,.ShtJjG_workspaceDropBefore:before,.ShtJjG_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.ShtJjG_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.ShtJjG_listTopDropActive>.ShtJjG_workspaceDropBefore:first-child:before{display:none}.ShtJjG_workspaceDropBefore:before{top:-8px}.ShtJjG_workspaceDropAfter:after{bottom:-8px}.ShtJjG_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.ShtJjG_groupSection>.ShtJjG_sessionOverflowButton{margin-top:0}.ShtJjG_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.ShtJjG_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.ShtJjG_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.ShtJjG_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.ShtJjG_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.ShtJjG_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.ShtJjG_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.ShtJjG_wide{animation:none}.ShtJjG_search,.ShtJjG_sectionLabel,.ShtJjG_searchSlot,.ShtJjG_searchInput,.ShtJjG_headerActions{transition:none}}";
