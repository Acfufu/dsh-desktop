window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-sidebar/src/client/SidebarRoot.module.css.mjs
		const css = ".jBgPWa_root{--dsh-sidebar-inline-padding:12px;height:100%;padding:6px var(--dsh-sidebar-inline-padding);box-sizing:border-box;background:var(--dsw-specific-sidebar-fill);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex-direction:column;font-size:14px;display:flex}.jBgPWa_root.jBgPWa_collapsed{padding:18px 10px 6px}.jBgPWa_root.jBgPWa_quietBars{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.jBgPWa_fading>*{opacity:0;transition:opacity .15s var(--ds-ease-in-out)}.jBgPWa_wide{animation:jBgPWa_wide-in .2s var(--ds-ease-in-out)}@keyframes jBgPWa_wide-in{0%{opacity:0}}.jBgPWa_railIn .jBgPWa_iconButton,.jBgPWa_railIn .jBgPWa_newSession,.jBgPWa_railIn .jBgPWa_regionArea{animation:jBgPWa_rail-in .15s var(--ds-ease-in-out) backwards}.jBgPWa_railIn .jBgPWa_footArea{animation:jBgPWa_rail-fade-in .15s var(--ds-ease-in-out) backwards}@keyframes jBgPWa_rail-in{0%{opacity:0;transform:translate(49px)}}@keyframes jBgPWa_rail-fade-in{0%{opacity:0}}.jBgPWa_logoRow{box-sizing:border-box;flex:none;justify-content:flex-end;align-items:center;gap:8px;height:60px;margin-bottom:8px;padding:8px 0 8px 4px;display:flex;overflow:hidden}.jBgPWa_collapsed .jBgPWa_logoRow{justify-content:flex-start;height:36px;margin-bottom:12px;padding:0}.jBgPWa_brand{min-width:0;color:inherit;cursor:pointer;background:0 0;border:none;flex:1;align-items:center;padding:0;display:inline-flex;overflow:hidden}.jBgPWa_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.jBgPWa_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.jBgPWa_collapsed .jBgPWa_iconButton{width:36px;height:36px}.jBgPWa_collapsed .jBgPWa_toggle .jBgPWa_panelIcon{display:none}.jBgPWa_collapsed .jBgPWa_toggle:hover .jBgPWa_panelIcon{display:inline}.jBgPWa_collapsed .jBgPWa_toggle:hover .jBgPWa_railFish{display:none}.jBgPWa_collapsed .jBgPWa_iconButton{color:var(--dsw-alias-label-primary)}.jBgPWa_newSession{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);height:38px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:12px;flex:none;justify-content:center;align-items:center;gap:6px;margin:0 2px 8px;padding:8px 16px;font-size:14px;font-weight:500;line-height:22px;display:flex;overflow:hidden}.jBgPWa_newSession:hover{background:var(--dsw-alias-button-floating-hover)}.jBgPWa_collapsed .jBgPWa_newSession{background:0 0;border-color:#0000;align-self:flex-start;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.jBgPWa_collapsed .jBgPWa_newSession:hover{background:var(--dsw-alias-interactive-bg-hover)}.jBgPWa_newSessionLabel{white-space:nowrap;max-width:200px;overflow:hidden}.jBgPWa_collapsed .jBgPWa_newSessionLabel{max-width:0}.jBgPWa_regionArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-sidebar-inline-padding));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:hidden}.jBgPWa_collapsed .jBgPWa_regionArea{margin-left:0;margin-right:0;padding-left:0}.jBgPWa_footArea{flex-direction:column;flex:none;display:flex}.jBgPWa_settingsArea,.jBgPWa_footerActions{flex:none;width:100%;min-width:0}.jBgPWa_footerActions{display:flex}.jBgPWa_collapsed .jBgPWa_footArea{align-items:center}.jBgPWa_collapsed .jBgPWa_settingsArea,.jBgPWa_collapsed .jBgPWa_footerActions{justify-content:center;width:auto;display:flex}@media (prefers-reduced-motion:reduce){.jBgPWa_wide,.jBgPWa_fading>*,.jBgPWa_railIn .jBgPWa_iconButton,.jBgPWa_railIn .jBgPWa_newSession,.jBgPWa_railIn .jBgPWa_footArea,.jBgPWa_railIn .jBgPWa_regionArea{transition:none;animation:none}}";
