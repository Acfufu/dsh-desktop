window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetLabel.module.css.mjs
		const css$3 = ".No01Jq_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.No01Jq_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetRow.module.css.mjs
		const css$2 = ".SxOe2G_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.SxOe2G_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.SxOe2G_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.SxOe2G_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.SxOe2G_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.SxOe2G_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.SxOe2G_selector:disabled{cursor:default}.SxOe2G_chevron{flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSeat.module.css.mjs
		const css$1 = ".gX1QrW_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.gX1QrW_seat:not(:disabled):hover,.gX1QrW_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.gX1QrW_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.gX1QrW_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.gX1QrW_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both gX1QrW_seat-icon-in}@keyframes gX1QrW_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.gX1QrW_introText{white-space:pre;display:inline-block}.gX1QrW_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards gX1QrW_seat-char-in;display:inline-block}@keyframes gX1QrW_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.gX1QrW_introIcon,.gX1QrW_introChar{opacity:1;animation:none}}.gX1QrW_chevron{color:var(--dsw-alias-label-caption);flex:none}.gX1QrW_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.gX1QrW_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.gX1QrW_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-agent-preset/src/client/AgentPresetSection.module.css.mjs
		const css = ".nzZ04a_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.nzZ04a_title{margin:0;font-size:18px;font-weight:600}.nzZ04a_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.nzZ04a_group{flex-direction:column;gap:10px;display:flex}.nzZ04a_group+.nzZ04a_group{margin-top:20px}.nzZ04a_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.nzZ04a_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.nzZ04a_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.nzZ04a_card:hover:not(.nzZ04a_cardActive){border-color:var(--dsw-alias-label-dimmed)}.nzZ04a_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.nzZ04a_cardBroken,.nzZ04a_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.nzZ04a_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.nzZ04a_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.nzZ04a_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.nzZ04a_cardMain:disabled{cursor:default}.nzZ04a_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.nzZ04a_cardHead{align-items:center;gap:8px;display:flex}.nzZ04a_cardName{font-size:15px;font-weight:600;line-height:1.4}.nzZ04a_badge,.nzZ04a_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.nzZ04a_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.nzZ04a_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.nzZ04a_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.nzZ04a_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.nzZ04a_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.nzZ04a_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.nzZ04a_iconButton:disabled{opacity:.4;cursor:default}.nzZ04a_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.nzZ04a_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.nzZ04a_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.nzZ04a_iconButton:hover:after,.nzZ04a_iconButton:focus-visible:after{opacity:1}.nzZ04a_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.nzZ04a_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.nzZ04a_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.nzZ04a_revealedPathLabel{white-space:nowrap}.nzZ04a_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.nzZ04a_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.nzZ04a_secondaryButton:disabled{opacity:.5;cursor:default}.nzZ04a_field{flex-direction:column;gap:6px;display:flex}.nzZ04a_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.nzZ04a_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.nzZ04a_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.nzZ04a_input::placeholder{color:var(--dsw-alias-label-dimmed)}.nzZ04a_dialog{width:min(560px,100%)}.nzZ04a_dialogFields{flex-direction:column;gap:12px;display:flex}.nzZ04a_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.nzZ04a_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.nzZ04a_deleteDialog{width:min(480px,100%)}.nzZ04a_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.nzZ04a_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.nzZ04a_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.nzZ04a_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.nzZ04a_creatorButton:disabled{opacity:.4;cursor:default}";
