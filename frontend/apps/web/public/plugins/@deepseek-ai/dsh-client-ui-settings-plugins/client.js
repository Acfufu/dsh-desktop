window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-settings-plugins/src/client/fields.module.css.mjs
		const css$2 = "._8xwsaa_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}._8xwsaa_field+._8xwsaa_field{border-top:1px solid var(--dsw-alias-border-l2)}._8xwsaa_head{align-items:center;gap:8px;display:flex}._8xwsaa_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}._8xwsaa_badges{align-items:center;gap:8px;display:inline-flex}._8xwsaa_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._8xwsaa_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}._8xwsaa_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}._8xwsaa_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}._8xwsaa_reset:disabled{cursor:default}._8xwsaa_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}._8xwsaa_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}._8xwsaa_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}._8xwsaa_inputInvalid{border-color:var(--dsw-alias-label-error);}._8xwsaa_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}._8xwsaa_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginCard.module.css.mjs
		const css$1 = ".Hd0xMq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.Hd0xMq_card:hover{border-color:var(--dsw-alias-label-dimmed)}.Hd0xMq_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.Hd0xMq_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.Hd0xMq_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.Hd0xMq_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.Hd0xMq_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.Hd0xMq_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.Hd0xMq_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.Hd0xMq_chevronOpen{transform:rotate(180deg)}.Hd0xMq_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.Hd0xMq_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.Hd0xMq_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Hd0xMq_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.Hd0xMq_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.Hd0xMq_discard,.Hd0xMq_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.Hd0xMq_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.Hd0xMq_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.Hd0xMq_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.Hd0xMq_discard:disabled,.Hd0xMq_save:disabled{opacity:.4;cursor:default}.Hd0xMq_discard:focus-visible,.Hd0xMq_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-settings-plugins/src/client/PluginsSettingsSection.module.css.mjs
		const css = ".SKKciG_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.SKKciG_heading{margin:0;font-size:18px;font-weight:600}.SKKciG_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.SKKciG_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.SKKciG_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.SKKciG_tab:hover,.SKKciG_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.SKKciG_tab[data-active=true]:after,.SKKciG_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.SKKciG_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.SKKciG_panel{min-width:0;padding-top:2px}.SKKciG_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.SKKciG_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
