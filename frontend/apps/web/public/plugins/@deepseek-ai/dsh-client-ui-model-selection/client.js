window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-model-selection/src/client/ModelSelect.module.css.mjs
		const css = ".ZGJA7W_root{min-width:0;position:relative}.ZGJA7W_trigger{min-width:0;max-width:220px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:24px;outline:none;align-items:center;gap:4px;padding:0 4px 0 8px;font-size:13px;font-weight:500;line-height:20px;display:flex}.ZGJA7W_trigger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.ZGJA7W_trigger:focus-visible{box-shadow:0 0 0 2px var(--dsw-alias-border-l3)}.ZGJA7W_trigger:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.ZGJA7W_triggerLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.ZGJA7W_triggerEffort{color:var(--dsw-alias-label-caption);flex:none}.ZGJA7W_chevron{color:var(--dsw-alias-label-caption);flex:none;transition:transform .12s}.ZGJA7W_chevronOpen{transform:rotate(180deg)}.ZGJA7W_menu{z-index:20;border:1px solid var(--dsw-alias-border-inverted);background:var(--dsw-specific-menu);width:min(240px,100vw - 32px);max-height:min(360px,100vh - 96px);box-shadow:var(--dsw-shadow-lv3);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;bottom:calc(100% + 8px);right:0;overflow:hidden}.ZGJA7W_status,.ZGJA7W_empty{color:var(--dsw-alias-label-tertiary);padding:10px;font-size:13px;line-height:20px}.ZGJA7W_error,.ZGJA7W_warning{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary);border-radius:8px;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:4px;padding:7px 8px;font-size:12px;line-height:18px;display:flex}.ZGJA7W_warning{background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-state-warn-label)}.ZGJA7W_retry{color:inherit;font:inherit;cursor:pointer;background:0 0;border:none;flex:none;padding:0;font-weight:600}.ZGJA7W_groups{min-height:0;overflow-y:auto}.ZGJA7W_group+.ZGJA7W_group{margin-top:4px}.ZGJA7W_groupTitle{z-index:1;background:var(--dsw-specific-menu);color:var(--dsw-alias-label-tertiary);padding:5px 8px 3px;font-size:12px;font-weight:500;line-height:18px;position:sticky;top:0}.ZGJA7W_option{width:100%;min-height:38px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:10px;outline:none;align-items:center;gap:8px;padding:6px 8px;display:flex}.ZGJA7W_option:hover:not(:disabled),.ZGJA7W_option:focus-visible{background:var(--dsw-alias-interactive-bg-hover)}.ZGJA7W_selected{background:0 0}.ZGJA7W_option:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.ZGJA7W_optionCopy{flex-direction:column;flex:1;min-width:0;display:flex}.ZGJA7W_modelName{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:500;line-height:20px;overflow:hidden}.ZGJA7W_description{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}.ZGJA7W_check{color:var(--dsw-alias-label-primary);flex:0 0 18px;place-items:center;display:grid}.ZGJA7W_cell{width:100%;height:40px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;background:0 0;border:none;border-radius:10px;align-items:center;gap:8px;padding:0 10px;font-size:14px;line-height:22px;display:flex}.ZGJA7W_cell:hover{background:var(--dsw-alias-interactive-bg-hover)}.ZGJA7W_cellLabel{text-overflow:ellipsis;white-space:nowrap;flex:auto;min-width:0;overflow:hidden}.ZGJA7W_cellValue{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:0 auto;overflow:hidden}.ZGJA7W_cellChevron{color:var(--dsw-alias-label-tertiary);flex:none}";
		...
		var ModelSelect_module_css_default = {
			"option": "ZGJA7W_option",
			"groupTitle": "ZGJA7W_groupTitle",
			"retry": "ZGJA7W_retry",
			"optionCopy": "ZGJA7W_optionCopy",
			"triggerLabel": "ZGJA7W_triggerLabel",
			"modelName": "ZGJA7W_modelName",
			"warning": "ZGJA7W_warning",
			"check": "ZGJA7W_check",
			"cell": "ZGJA7W_cell",
			"triggerEffort": "ZGJA7W_triggerEffort",
			"cellValue": "ZGJA7W_cellValue",
			"error": "ZGJA7W_error",
			"trigger": "ZGJA7W_trigger",
			"cellLabel": "ZGJA7W_cellLabel",
			"groups": "ZGJA7W_groups",
			"root": "ZGJA7W_root",
			"chevron": "ZGJA7W_chevron",
			"empty": "ZGJA7W_empty",
			"selected": "ZGJA7W_selected",
			"group": "ZGJA7W_group",
			"description": "ZGJA7W_description",
			"cellChevron": "ZGJA7W_cellChevron",
			"status": "ZGJA7W_status",
			"chevronOpen": "ZGJA7W_chevronOpen",
			"menu": "ZGJA7W_menu"
		};
		//#endregion
