window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisRunRow.module.css.mjs
		const css$2 = "._1pRGNa_card{flex-direction:column;gap:8px;display:flex}._1pRGNa_row{align-items:center;min-height:32px;display:flex}._1pRGNa_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}._1pRGNa_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}._1pRGNa_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}._1pRGNa_summary,._1pRGNa_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}._1pRGNa_error{color:var(--dsw-alias-state-error-primary)}._1pRGNa_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}._1pRGNa_card[data-cordis-status=awaiting-approval] ._1pRGNa_status,._1pRGNa_card[data-cordis-status=client-pending] ._1pRGNa_status{color:var(--dsw-alias-state-warn-label)}._1pRGNa_card[data-cordis-status=running] ._1pRGNa_status{color:var(--dsw-alias-state-success-primary)}._1pRGNa_card[data-cordis-status=failed] ._1pRGNa_status{color:var(--dsw-alias-state-error-primary)}._1pRGNa_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}._1pRGNa_card:hover ._1pRGNa_inspect,._1pRGNa_inspect:focus-visible{opacity:1}._1pRGNa_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}._1pRGNa_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}._1pRGNa_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}._1pRGNa_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}._1pRGNa_business ._1pRGNa_output{border:none;border-radius:0}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisDefineRow.module.css.mjs
		const css$1 = ".SNQn2q_card{flex-direction:column;display:flex}.SNQn2q_card .SNQn2q_title,.SNQn2q_card .SNQn2q_chevron{color:var(--dsw-alias-state-business-primary)}.SNQn2q_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.SNQn2q_row{gap:0}.SNQn2q_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.SNQn2q_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.SNQn2q_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.SNQn2q_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.SNQn2q_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.SNQn2q_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.SNQn2q_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.SNQn2q_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.SNQn2q_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.SNQn2q_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.SNQn2q_switch{height:22px;padding:0 8px;font-size:12px}.SNQn2q_card[data-terminal] .SNQn2q_title,.SNQn2q_card[data-terminal] .SNQn2q_name,.SNQn2q_card[data-terminal] .SNQn2q_purpose,.SNQn2q_card[data-terminal] .SNQn2q_statusLabel{color:var(--dsw-alias-label-caption)}.SNQn2q_card[data-terminal] .SNQn2q_separator{background:var(--dsw-alias-label-caption)}.SNQn2q_bodyWrap{flex-direction:column;display:flex}.SNQn2q_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.SNQn2q_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.SNQn2q_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.SNQn2q_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.SNQn2q_sourceTab:disabled{cursor:default;opacity:.4}.SNQn2q_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.SNQn2q_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.SNQn2q_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.SNQn2q_sourcePanel{max-height:260px;overflow:auto}.SNQn2q_sourceCode{margin:0}.SNQn2q_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.SNQn2q_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.SNQn2q_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.SNQn2q_output[data-error]{color:var(--dsw-alias-state-error-primary)}.SNQn2q_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.SNQn2q_card:hover .SNQn2q_inspectButton,.SNQn2q_inspectButton:focus-visible{opacity:1}.SNQn2q_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.SNQn2q_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.SNQn2q_inspectButton{transition:none}}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/extensions/ui-cordis/src/client/CordisPanel.module.css.mjs
		const css = ".Yz16Wa_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.Yz16Wa_footerButtons{align-items:center;width:100%;display:flex}.Yz16Wa_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.Yz16Wa_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.Yz16Wa_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.Yz16Wa_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.Yz16Wa_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.Yz16Wa_layer.Yz16Wa_rail{width:36px;height:36px;margin:0}.Yz16Wa_rail .Yz16Wa_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.Yz16Wa_rail .Yz16Wa_footerButtons{flex-direction:column;gap:2px}.Yz16Wa_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.Yz16Wa_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.Yz16Wa_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.Yz16Wa_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.Yz16Wa_note,.Yz16Wa_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.Yz16Wa_readError{color:var(--dsw-alias-state-error-primary)}.Yz16Wa_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.Yz16Wa_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.Yz16Wa_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.Yz16Wa_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.Yz16Wa_rowHead{align-items:center;gap:8px;display:flex}.Yz16Wa_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.Yz16Wa_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.Yz16Wa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.Yz16Wa_row[data-cordis-status=idle] .Yz16Wa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.Yz16Wa_row[data-cordis-status=awaiting-approval] .Yz16Wa_rowStatus,.Yz16Wa_row[data-cordis-status=client-pending] .Yz16Wa_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.Yz16Wa_row[data-cordis-status=failed] .Yz16Wa_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.Yz16Wa_row[data-cordis-status=running] .Yz16Wa_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.Yz16Wa_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.Yz16Wa_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.Yz16Wa_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.Yz16Wa_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.Yz16Wa_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.Yz16Wa_rowActions{flex:none;align-items:center;gap:10px;display:flex}.Yz16Wa_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.Yz16Wa_transitionActions{gap:6px;margin-left:auto;display:flex}.Yz16Wa_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.Yz16Wa_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Yz16Wa_transitionActions button:disabled{opacity:.4;cursor:default}.Yz16Wa_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.Yz16Wa_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.Yz16Wa_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.Yz16Wa_actionButton:disabled{opacity:.4;cursor:default}.Yz16Wa_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.Yz16Wa_doubleCheck svg{position:absolute;top:1px}.Yz16Wa_doubleCheck svg:first-child{opacity:.7;left:0}.Yz16Wa_doubleCheck svg:last-child{left:5px}";
