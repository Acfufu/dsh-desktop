window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".spW6IW_root{flex-direction:column;display:flex}.spW6IW_row{position:relative;overflow:hidden}.spW6IW_root[data-state=running] .spW6IW_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite spW6IW_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes spW6IW_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.spW6IW_leading{flex-shrink:0}.spW6IW_root[data-tool^=cordis_] .spW6IW_leading,.spW6IW_root[data-tool^=cordis_] .spW6IW_title{color:var(--dsw-alias-state-business-primary)}.spW6IW_root[data-tool^=cordis_] .spW6IW_title{font-weight:500}.spW6IW_root[data-tool^=cordis_] .spW6IW_sep{background:var(--dsw-alias-state-business-primary)}.spW6IW_chevron{color:var(--dsw-alias-label-secondary)}.spW6IW_title{font-weight:400}.spW6IW_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.spW6IW_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.spW6IW_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.spW6IW_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.spW6IW_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.spW6IW_errorSummary{color:var(--dsw-alias-state-error-primary)}.spW6IW_bodyWrap{flex-direction:column;display:flex}.spW6IW_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.spW6IW_root:hover .spW6IW_inspectButton,.spW6IW_inspectButton:focus-visible{opacity:1}.spW6IW_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.spW6IW_bodyScroll{max-height:260px;overflow-y:auto}.spW6IW_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.spW6IW_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.spW6IW_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.spW6IW_ioSection::-webkit-scrollbar-track{margin:6px 0}.spW6IW_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.spW6IW_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.spW6IW_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.spW6IW_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.spW6IW_codeBody,.spW6IW_terminalBody,.spW6IW_diffBody,.spW6IW_readBody,.spW6IW_searchBody,.spW6IW_webBody{margin:4px 0 4px 4px}.spW6IW_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.spW6IW_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.spW6IW_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.spW6IW_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = "._nwa2q_callRow{border-radius:6px}._nwa2q_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".m6lxrW_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.m6lxrW_cardBody{margin:0}.m6lxrW_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.m6lxrW_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.m6lxrW_code[data-error]{color:var(--dsw-alias-state-error-primary)}.m6lxrW_read,.m6lxrW_web{margin:0}.m6lxrW_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/acfufu/Codehub/deepseek-harness/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".zwZo4a_card{flex-direction:column;display:flex}.zwZo4a_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.zwZo4a_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.zwZo4a_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.zwZo4a_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.zwZo4a_ioSection::-webkit-scrollbar-track{margin:6px 0}.zwZo4a_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.zwZo4a_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.zwZo4a_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.zwZo4a_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.zwZo4a_root[data-expandable]{cursor:pointer}.zwZo4a_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.zwZo4a_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite zwZo4a_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes zwZo4a_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.zwZo4a_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.zwZo4a_chevron{color:var(--dsw-alias-label-secondary)}.zwZo4a_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.zwZo4a_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.zwZo4a_root:hover .zwZo4a_iconIdle{opacity:0}.zwZo4a_root:hover .zwZo4a_chevronHover{opacity:1}.zwZo4a_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.zwZo4a_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.zwZo4a_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.zwZo4a_errorSummary{color:var(--dsw-alias-state-error-primary)}.zwZo4a_bodyWrap{flex-direction:column;display:flex}.zwZo4a_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.zwZo4a_card:hover .zwZo4a_inspectButton,.zwZo4a_inspectButton:focus-visible{opacity:1}.zwZo4a_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.zwZo4a_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
